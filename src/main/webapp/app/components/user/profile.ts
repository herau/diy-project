...
@Component({
  ...
  <div class="field">
    ...
    <div class="two fields">
      <div class="field">
        <input type="text" value="{{user.firstname}}" name="data[firstname]" placeholder="First Name" disabled>
      </div>
      <div class="field">
        <input type="text" value="{{user.lastname}}" name="data[lastname]" placeholder="Last Name" disabled>
      </div>
    </div>
  </div>
  <div class="field">
    <label>E-mail</label>
    <input type="text" value="{{user.email}}" name="data[email]" placeholder="E-mail">
  </div>
  <div class="field">
    <div class="three fields">
      <div class="field">
        <label>Address</label>
        <input type="text" name="data[address]" placeholder="Street Address">
      </div>
      <div class="field">
        <label>ZIP Code</label>
        <input type="text" name="data[code]" placeholder="ZIP Code">
      </div>
      <div class="field">
        <label>City</label>
  ...
  <div class="one fields">
    ...
    <div class="field">
      <div class="two fields">
        <div class="field">
          <label>Company</label>
          <input type="text" value="{{user.company}}" name="data[company]" placeholder="Company" disabled>
        </div>
        <div class="field">
          <label>Personal Number</label>
          <input type="text" value="{{user.personalNumber}}" name="data[personalNumber]" placeholder="Personal Number" disabled>
        </div>
      </div>
    </div>
